...
public class DBConnection {
    ...
    private static final String dbName = "skillbox";
    private static final String dbUser = "root";
    private static final String dbPass = "7413698Aa";
    ...
    public static void printVoterCounts () throws SQLException {
        String sql = "SELECT voter.id, voter.name, voter.birthDate, count(*) c FROM skillbox.voter_count voter  group by concat(name, birthDate) having c > 1 order by name";
